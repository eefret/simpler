package com.kaissersoft.simpler;
...
public class Simpler {
    ...
    //TODO Create a Time based extra in the tags (include the execution time at log)
    //======================================================================================
    //ENUMS
    //======================================================================================
    ...
    //CONSTANTS
    //======================================================================================
    private static final String personalTAG = "Simpler";
    ...
    private Simpler(){
        if(LoggerLoader.instance != null){
            Log.e(personalTAG,"Error: Simpler already instantiated");
     ...
     * getLogger Method
     * The Perfect Singleton Pattern as Joshua Bosch Explained at his Effective Java Reloaded talk at Google I/O 2008
     * @return Simpler (This instance)
     */
    public static Simpler getLogger(){
    ...
    public void d(String msg){
        try {
            ...
            Log.e(getTag(LOGGER_DEPTH.ACTUAL_METHOD), "Simpler failed, exception: "+exception.getMessage());
        }
    }

    /**
     * d Method that takes LOGGER_DEPTH as the second parameter, will log custom depth level
     * @see Simpler.LOGGER_DEPTH
     * @param msg
     * @param depth
     */
    ...
    /**
     * Simpler Loader Class
     * The Perfect Singleton Pattern as Joshua Bosch Explained at his Effective Java Reloaded talk at Google I/O 2008
     */
    private static class LoggerLoader {
        private static final Simpler instance = new Simpler();
    }
}